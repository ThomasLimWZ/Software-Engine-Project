...
$result = mysqli_query($connect, "SELECT SUM(`order`.order_grandtotal) AS total, YEAR(`order`.order_datetime) AS year, MONTH(`order`.order_datetime) AS month FROM `order`

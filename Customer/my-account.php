...
<body>
	                			...
	                			<div class="tab-content">
								    ...
								    <div class="tab-pane fade" id="tab-reset-password" role="tabpanel" aria-labelledby="tab-reset-password-link">
								    	<form action="#" method="post">
											...
											<button type="button" class="btn btn-outline-primary-2" onclick="clear_all_value()" style="padding:12px 0px">
			                					<span>Clear</span>
	...
	<script>
		...
		function clear_all_value()
		{
			...
			document.getElementById("new_comfirm_password").value="";
				...
				echo "
					<script>
						Swal.fire(
							...
							'',
							'success'
						).then(() => window.location.assign('my-account.php'));	
					</script>
				";
			}
			else
		...
		?>
			<script>
				Swal.fire(
					...
					window.location.assign("my-account.php?goto=tab-reset-password");
				});;
			</script>
		<?php
	}
